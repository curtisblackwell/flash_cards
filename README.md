...
1. ### Put the files in place.  
   ...
   | Files | Location |
   | :     | :        |
   | <h4>If you're using [SASS](http://sass-lang.com/)/[Compass](http://compass-style.org/):</h4> `_flash_cards.scss` and `_fonts.scss`<h4>If you're not using SASS/Compass:</h4> `flash_cards.css` | <br>Your SASS directory<br><br> Your CSS directory |
